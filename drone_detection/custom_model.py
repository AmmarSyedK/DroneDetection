...
cap = cv2.imread("image.jpg")   # if you have multiple webcams change the value to the correct one
...
MODEL_NAME = 'google_collab_trained_model'  # change to whatever folder has the new graph
